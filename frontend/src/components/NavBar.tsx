...
export default function NavBar() {
  ...
  return (
    <nav className="flex justify-center gap-5">
      ...
      <button
        className="m-3 p-4 text-xl bg-blue-400 hover:bg-blue-500 rounded-md font-medium fill-white"
        onClick={changeTheme}
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="fill-white w-6 h-6">
